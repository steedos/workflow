JsonRoutes.add 'post', '/api/sogo/notify', (req, res, next) ->
	try
		console.log "/api/sogo/notify======post==========================================================post====="
...
JsonRoutes.add 'get', '/api/sogo/notify', (req, res, next) ->
	try
		console.log "/api/sogo/notify======get===========================================================get===="
		console.log "time:", new Date()
		console.log "headers:", req.headers
		console.log "method:", req.method
		console.log "body:", req.body
...
JsonRoutes.add 'put', '/api/sogo/notify', (req, res, next) ->
	try
		console.log "/api/sogo/notify======put===========================================================put===="
		console.log "time:", new Date()
		console.log "headers:", req.headers
		console.log "method:", req.method
		console.log "body:", req.body
