...
JsonRoutes.add 'get', '/tableau/workflow/space/:space/cost_time/details', (req, res, next) ->
	...
	if space
		...
		html = Assets.getText("assets/instances/instance_avg_cost_time_details_connectors.html")
