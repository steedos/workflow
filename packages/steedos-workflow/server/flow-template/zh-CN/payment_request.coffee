...
workflowTemplate["zh-CN"].push {
  ...
  "current": {
    ...
    "fields": [
      {
        "_id": "46242B7F-F114-4003-9D70-8792B3B0174C",
        "code": "提交人信息",
        "is_required": false,
        "is_wide": true,
        "type": "section",
        ...
        "fields": [
          {
            "_id": "49B06612-96F3-417B-B06E-C478E853D3A6",
            "code": "提交人",
            "is_required": true,
            "is_wide": false,
            "type": "input",
          ...
          {
            "_id": "62AF6CD7-3CF3-4C4C-A6DE-FD0770C4466D",
            "code": "职务",
          ...
          {
            "_id": "4E063818-B26F-4A96-83AA-2A2B48B7A392",
            "code": "部门",
            "is_required": true,
            "is_wide": true,
            "type": "input",
