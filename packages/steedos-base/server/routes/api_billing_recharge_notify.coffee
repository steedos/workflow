	...
	try
		...
		req.on('end', Meteor.bindEnvironment((()->
				...
				parser.parseString(body, (err, result)->
					if result.return_code isnt 'SUCCESS'
						console.error '/api/billing/recharge/notify: ', return_msg
						return
					if result.result_code isnt 'SUCCESS'
						console.error '/api/billing/recharge/notify: ', err_code
						console.error '/api/billing/recharge/notify: ', err_code_des
						return
					...
					bpr = db.billing_pay_records.findOne({_id: code_url_id, paid: {$ne: true}})
